...
const DEMO_PROJECT_OPTIONS = [
  {
    ...
    gcpProjectId: "analytics-platform-53335",
    gcsBucket: "analytics-platform-53335-word-catcher",
    boundsPath: "gs://analytics-platform-53335-word-catcher/bounds/word-catcher/",
    appIds: ["3927166"],
